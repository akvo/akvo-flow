...
/**
 * Summarizer that handles creation of SubCountry domain objects in response to
 * persistence of a OGRFeature. As with all DataSummarizers, this class is NOT
 * thread-safe.
 * 
...
public class SubCountrySummarizer implements DataSummarizer {
	 ...
	 * @param countryCode
	 * @param value
	 *            - packed string of sub level values
	 * @return
	 */
