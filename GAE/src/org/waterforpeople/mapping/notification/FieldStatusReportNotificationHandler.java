...
/**
 * report notification handler that can generate the field status report (a
 * simple report consisting only of the list of instances for a given survey).
 * The format of the report is currently a tab-delimited text file with the following columns:<br>
