...
public class SurveyInstanceServiceImpl extends RemoteServiceServlet implements
    ...
    /**
     * updates the list of QAS dto objects passed in and fires summarization messages to the async
     * queues
     */
    @Override
    ...
    /**
     * marks the survey instance as approved, updating any changed answers as it does so and then
     * sends a processing message to the task queue so the instance can be summarized.
     */
