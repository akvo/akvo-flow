...
public class ChangeCompleteWidget extends  Composite implements ContextAware,
		AutoAdvancing {
	...
	public ChangeCompleteWidget() {
		surveyService = GWT.create(SurveyService.class);
		panel = new VerticalPanel();
		statusLabel = new Label(TEXT_CONSTANTS.pleaseWait());
	...
	public void advance(final CompletionListener listener) {
		surveyService.markSurveyChangesComplete(survey.getKeyId(),
