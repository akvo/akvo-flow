...
/**
 * Utility to wrap the Google Image Charts API. This class can be used to invoke
 * a call to the charts api that will return a byte array representing the
...
public class ImageChartUtil {
	...
	/**
	 * Gets a Pie chart for the values passed in that includes the raw data
	 * value as the data labels in addition to the legend. Due to the use of the
	 * labels, the chart usually needs to be wider than tall to prevent
	 * clipping.
	 * 
	 * The generated image chart is returned as a byte array representing a PNG
	 * image.
	 * 
	 * @param labels
	 *            - labels for the data in the Legend
	 * @param values
	 *            - double (or integer) values (number of values must match
	 *            number of labels)
	 * @param title
	 *            - chart title
	 * @param width
