...
/**
 * persistent class that represents a translation of some textual element. Translations can be
 * attached to many things in the system (defined by the parentType and parentId). Each translation
 * contains the language code and translation text.
 * 
