...
/**
 * Class to facilitate configuring new instances based on template based configuration files. The
 * files being generated are: appengine-web.xml UploadConstants.properties survey.properties To use
 * this utility, you must supply all of following values on the command line in order:
 * 
 * <pre>
...
public class InstanceConfigurator {
    ...
    public static void main(String[] args) {
        ...
        ic.addAttribute("restApiKey", args[15].equals("test") || args[15].equals("") ? UUID
                .randomUUID().toString() : args[15]);
