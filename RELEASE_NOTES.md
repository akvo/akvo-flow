...
# Resolved issues
* **Surveys** - Fix issue causing survey instances to fail if answers were too long and disabled adding options longer than 500 characters  in option questions [#3038]
