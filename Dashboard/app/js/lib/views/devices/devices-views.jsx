    ...
    getProps() {
      return {
        ...
        strings: {
          ...
          saveGroupName: Ember.String.loc('_save_group_name'),
          editGroupName: Ember.String.loc('_edit_group_name'),
          block: Ember.String.loc('_block'),
          unblock: Ember.String.loc('_unblock'),
          navText: {
            manageDeviceGroups: Ember.String.loc('_manage_device_groups'),
            addToDeviceGroup: Ember.String.loc('_add_to_device_group'),
            manageDevices: Ember.String.loc('_manage_devices'),
            newGroup: Ember.String.loc('_new_group'),
