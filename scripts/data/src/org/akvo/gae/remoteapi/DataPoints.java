...
public class DataPoints {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final File f = new File("/tmp/data-points.csv");

        FileUtils.write(f, "Instance,LastSurveyedDate,Latitude,Longitude", true);
        ...
        for (String i : instances) {
            ...
            try {
                ...
                for (Entity e : pq.asIterable()) {
                    ...
                    sb.append(
                            String.format("%s,%s,%s,%s", i, e.getProperty("lastSurveyedDate"),
                                    e.getProperty("latitude"), e.getProperty("longitude"))).append(
                            "\n");
                    j++;
                }
