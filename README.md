...
[![Build Status](https://akvo.semaphoreci.com/badges/akvo-flow/branches/master.svg?style=shields)](https://akvo.semaphoreci.com/projects/akvo-flow)
...
For more information on Akvo Flow, use these links to go directly to one of the corresponding pages:

* [Knowledge base](https://kb.akvo.org/flow/)
